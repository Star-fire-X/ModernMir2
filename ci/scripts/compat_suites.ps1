...
function Get-CiBuildTargets {
  ...
  $serverPhase2 = Join-Unique -Values ($serverPhase1 + @(
    ...
    "mir2_monster_visibility_order_smoke",
    ...
    "mir2_npc_instance_click_guard_smoke",
    ...
    "mir2_legacy_script_deferred_actions_smoke",
    "mir2_legacy_script_context_smoke",
    "mir2_legacy_script_parser_state_smoke",
    "mir2_legacy_mapquest_import_trigger_smoke",
    "mir2_legacy_gbk_import_smoke",
    "mir2_npc_shop_protocol_golden_smoke",
    "mir2_legacy_business_golden_smoke",
