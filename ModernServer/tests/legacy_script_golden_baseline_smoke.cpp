...
std::vector<LegacyScriptGoldenCase> golden_cases() {
  ...
  return {
      LegacyScriptGoldenCase{
          ...
          .script = "#IF\nCHECKLEVEL 1\n#ACT\nGIVE " + coin +
                    " 2\nTAKE " + coin + " 1\nSET [1] 1\n#SAY CoinBaseline",
          .packet_idents = {mir2::kSmTurn, mir2::kSmAddItem, mir2::kSmAddItem,
                            mir2::kSmBagItems, mir2::kSmWeightChanged,
                            mir2::kSmBagItems, mir2::kSmWeightChanged,
                            mir2::kSmMerchantSay},
          .say_prefix = "GoldenNpc/CoinBaseline",
          .bag_counts = {ItemCountExpectation{coin, 1}},
          .quest_mark0 = 0x80,
          .traces = {TraceExpectation{"give_item", true, 200000, coin},
                     TraceExpectation{"take_item", true, 1, "TAKE " + coin + " 1"}},
      },
      LegacyScriptGoldenCase{
          ...
          .say_prefix = "GoldenNpc/MonsterMapFail",
          .traces = {TraceExpectation{"condition", false, 0, "CHECKMONMAP 1 1"}},
      ...
      LegacyScriptGoldenCase{
          ...
          .traces = {TraceExpectation{"condition", true, 1, "CHECKHUM 1 2"}},
      },
      LegacyScriptGoldenCase{
          ...
          .traces = {TraceExpectation{"monclear", true, 0, "MONCLEAR 1"}},
          .monster = MonsterExpectation{"1", 1, true},
      },
      LegacyScriptGoldenCase{
