...
constexpr std::uint16_t kSmShowEvent = 804;
constexpr std::uint16_t kSmHideEvent = 805;
...
constexpr std::uint16_t kSmDealMenu = 673;
constexpr std::uint16_t kSmDealTryFail = 674;
constexpr std::uint16_t kSmDealAddItemOk = 675;
constexpr std::uint16_t kSmDealAddItemFail = 676;
constexpr std::uint16_t kSmDealDelItemOk = 677;
constexpr std::uint16_t kSmDealDelItemFail = 678;
constexpr std::uint16_t kSmDealCancel = 681;
constexpr std::uint16_t kSmDealRemoteAddItem = 682;
constexpr std::uint16_t kSmDealRemoteDelItem = 683;
constexpr std::uint16_t kSmDealChangeGoldOk = 684;
constexpr std::uint16_t kSmDealChangeGoldFail = 685;
constexpr std::uint16_t kSmDealRemoteChangeGold = 686;
constexpr std::uint16_t kSmDealSuccess = 687;
...
constexpr std::uint16_t kCmDealTry = 1025;
constexpr std::uint16_t kCmDealAddItem = 1026;
constexpr std::uint16_t kCmDealDelItem = 1027;
constexpr std::uint16_t kCmDealCancel = 1028;
constexpr std::uint16_t kCmDealChangeGold = 1029;
constexpr std::uint16_t kCmDealEnd = 1030;
